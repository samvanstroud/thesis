...
\begin{itemize}
  ...
  \item pileup
  \item each bunch crossing is an event
\end{itemize}
...
This is more than can be feasibly processed and stored, requiring the use of a trigger system which quickly makes a decision about whether or not an event is interesting and should be kept.
