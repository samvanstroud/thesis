...
The beams travel in opposite directions and are crossed\todo{say bunch crossing?} at four locations so that collisisons between protons can take place.
...
\begin{figure}[!htbp]
  ...
  \caption{
    The coordinate system used at the ATLAS detector. Reproduced from \cite{Strong:2020mge}.
  }
  \label{fig:atlas_coord_system}
\end{figure}

\todo{pseudorapidity def}
%    \item \textbf{Lorentz angle}. The Lorentz angle $\theta_L$ is the angle between the electric field and the direction of the drift of the electron and holes in a silicon strip or pixel detector, when submerged in a magnetic field.
...
\begin{figure}[!htbp]
  \centering
  \input{chapters/2.detector/figs/intlumivstimeRun2DQall.pdf}
  \caption{
...
\begin{figure}[!htbp]
  \centering
  \input{chapters/2.detector/figs/mu_2015_2018.pdf}
  \caption{
    mu_2015_2018 \cite{atlas-lumi-run2}.
  }
...
%An extensive software suite~ is used in the reconstruction and analysis of real and simulated data, in detector operations, and in the trigger and data acquisition systems of the experiment.
