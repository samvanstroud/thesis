...
If an separate algorithm could be trained to detect fake tracks, these could be removed before their input to the \btagging algorithms with the aim of improving performance.
In addition, other groups in \ATLAS that are sensitive to the presence of fake tracks would also benefit from this work.
...
\begin{figure}[!htbp]
    \centering
    \input{chapters/4.track_classifier/figs/neuron.tex}
    \caption{
...
\begin{figure}[!htbp]
  \centering
  \input{chapters/4.track_classifier/figs/activations.tex}
  \caption{
