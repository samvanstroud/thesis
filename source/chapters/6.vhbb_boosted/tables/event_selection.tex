\begin{sidewaystable}[p]
  ...
  %    Control regions &  \multicolumn{4}{c|}{> 1 add. \btagged track-jets} &  \multicolumn{2}{c}{ - } \\
    ...
    \caption{
      ...
      The $\min[\Delta \phi$(\vecmet, \smallR\ jets$)]$ selection is used to remove jets when the missing transverse momentum \vecmet is pointing in the direction of the Higgs candidate, and the $\Delta \phi (\vecmet, \vecmpt)$ is used to reject events where the calorimeter missing transverse momentum $\vecmet$ is not pointing in the direction of the track-based missing transverse momentum \vecmpt.
      The $\Delta y (V, H_{\text{cand}})$ quantifies the rapidity difference between the reconstructed vector boson and Higgs candidate ($H_{\text{cand}}$).
      \mll refers to the invariant mass of the two leptons, while $\pT^{\ell_{1}}$ and $\pT^{\ell_{2}}$ refer to the \pt of the first and second leptons, respectively.
    }
