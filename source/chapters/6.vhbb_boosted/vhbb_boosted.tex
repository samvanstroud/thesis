...
\begin{itemize}
  \item The \smallR jet energy scale and resolution, which are informed by in situ calibration studies and the dependence of the jet energy on the level of pile-up \cite{PERF-2016-04}.
...
\subsection{Post-fit Yields}\label{sec:postfit_yields}

The post-fit yields resulting from the unconditional fit to data are shown in \cref{tab:postfityield0L}, \cref{tab:postfityield1L}, and \cref{tab:postfityield2L} for the 0-, 1- and 2-lepton channels, respectively.
