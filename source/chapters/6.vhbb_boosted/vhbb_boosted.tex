...
This is done so that \todo{explain why ttbar} 
...
\begin{figure}[!htbp]
  ...
  \end{subfigure}%
  \hfill
  \caption{Leading \largeR jet mass for the  \Zboson and \Whf processes in the HP SR of the \zlep channel \cite{Dao:2688371}. The renormalisation scale $\mu_r$ has been varied by a factor of 2 (1up) and 0.5 (1down). An exponential function is fitted to the ratio between the nominal and alternate samples.}
  \label{fig:Vjets_SysMUR}
\end{figure}
\todo{ remove ATLAS Simulation/Internal label}
...
\begin{figure}[!htbp]
  ...
  \end{subfigure}%
  \hfill
  \caption{Leading \largeR jet \mJ inclusive in \ptv for the \Vhf process modelled using both the \SHERPA and \MADGRAPH samples \cite{Dao:2688371}.
...
\todo{The relevance of this discussion isn't clear or why these choices were made. Needs more detail and discussion}
...
Shapes are similar between \ptv bins, the 0- and 1-lepton channels and for $WZ$ and $ZZ$.\todo{More discussion is needed on the relevance of this comments, it isn't clear why this information is stated or what it means in the final implementation.A bit more detail is needed}
...
\begin{figure}[!htbp]
  ...
  \end{subfigure}
  \caption{
    The comparison on \mJ shapes between \SHERPA and \POWPYTHIA8 samples from $WZ$ and $ZZ$ process in high and low purity signal regions, integrated over \pTV regions and the 0- and 1-lepton channels \cite{Dao:2688371}.
...
\end{equation}
%
The predicted signal and background yields are also modified by the presence of the NPs with\todo{introduce what a pull is and what a contraint is here}
%
\begin{equation}
...
\todo{Add something in the previous section about howthe post-fit plots are produced?}
...
\todo{Make sure it is
clear in the text
what all these correspond
to, you might need to
add a few more
paragraphs on the main
...
to, you might need to
add a few more
paragraphs on the model
uncertainties for other backgrounds
(which you should also
have for completeness)}
