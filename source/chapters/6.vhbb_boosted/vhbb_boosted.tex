...
\begin{figure}[!htbp]
  ...
  \end{subfigure}
  \caption{
    The comparison of \mJ shapes between \SHERPA (black) and \POWHEG{}+\textsc{Pythia8} (red) samples from $WZ$ and $ZZ$ process in high and low purity signal regions, integrated over \pTV regions and the 0- and 1-lepton channels \cite{Dao:2688371}.
...
\todo{Also mention something about the impact of the dominant systematics and how they could be reduced}