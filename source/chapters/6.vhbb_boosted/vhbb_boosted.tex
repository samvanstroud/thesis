...
Events in the 0- and 1-lepton channels are further split depending on the number of additional untagged \smallR jets
...
The combined selections in \cref{sec:vhbb_selections} result in a signal efficiency ranging from 6--\pct{16} for the $\Wboson\higgs$ and $\Zboson\higgs$ processes depending on the channel and \ptv bin.
