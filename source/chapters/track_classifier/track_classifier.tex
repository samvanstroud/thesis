...
The ReLU activation function was used in conjunction with the Adam optimiser with a learning rate of $1e-3$.
...
\begin{figure}[!htbp]
  ...
  \end{subfigure}
  \caption{
    (left) A histogram of the model output separated for good and fake tracks, and further separated by those tracks which are from the decay of a \bhadron.
