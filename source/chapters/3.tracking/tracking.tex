...
In this section some common definition used in flavour tagging are given in \cref{sec:ftag_defs}, followed by a description of the various \btagging algorithms used in ATLAS in \cref{sec:low_level_algs,sec:high_level_algs}.
...
% TODO: add vertexing section here??? or say something more like "the sec vert reco algs described in xx can be used to identify b-jets"....
...
As discussed, a necessary requirement for successful \btagging is the efficient and accurate reconstruction of the charged particle trajectories in the jet.
...
%\todo{include plot from sebs study showing they are approx similar impacts? or just mention result? Can do put need to remove ATLAS labels. Alternatively you can put an interal reference to his work and state what the outcome is}
