...
Many ATLAS analyses rely on \btagging, which is the identification of jets instantiated by \bhadrons (\bjets), as opposed to those instantiated by quarks ($c$- and light-flavour hadrons).
These \bjet identification algorithms (also called \textit{taggers}) work by identifying the unique signatures of \bjets, which are outlined in \cref{sec:b_had_reco}.
