\chapter{Tracking and Flavour Tagging at High $p_\textrm{T}$}\label{chap:tracking}
...
In this chapter studies investigating the challenges facing track reconstruction and flavour tagging at \highpt are discussed.


The chapter is structured as follows.
In \cref{sec:track_classifier_datasets} an introduction to the datasets used in this thesis is given.
The unique signatures of \bjets are outlined in \cref{sec:b_had_reco}.
...
\section{Investigations into High \texorpdfstring{\pT}{pT} \bhadron Tracking Improvements}\label{sec:b_track_reco_improvements}
