...
Approximately \pct{60} of the time the Higgs decays to a pair of \bquarks, the dominant decay mode since the Higgs it not massive enough to decay to a pair for top quarks ($m_b = \SI{4.18}{\GeV}$ vs $m_t = \SI{173}{\GeV}$).
