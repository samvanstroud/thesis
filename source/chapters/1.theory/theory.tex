...
The strength of the coupling between the Higgs and some other particle is proportional to that particle's mass.
...
Although gluon-gluon fusion is the dominant production mode, the associated Higgs production with a vector boson has the advantage of leading to a more conspicuous final state due to the likelihood of the vector bosons decaying leptons.
...
This thesis presents Higgs analyses using events with a Higgs produced in association with vector boson, where the Higgs decays to a pair of \bquarks, i.e. $pp \rightarrow VH(bb)$.
The \Hbb decay mode directly probes the Higgs coupling to the second generation fermions, and more specifically to bottom quark.
